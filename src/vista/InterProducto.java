...
public class InterProducto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jComboBox_categoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 170, 170, -1));

        jButton_Guardar.setBackground(new java.awt.Color(0, 204, 204));
        jButton_Guardar.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButton_Guardar.setText("Añadir Producto");
        ...
        getContentPane().add(jButton_Guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 220, 150, 30));
            ...
            if (!controlProducto.existeProducto(txt_nombre.getText().trim())) {
                if (categoria.equalsIgnoreCase("Seleccione categoria:")) {
                    ...
                    try {
                        ...
                        // Procesar el precio, con soporte para ',' como punto decimal
