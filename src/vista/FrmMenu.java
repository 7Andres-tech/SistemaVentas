...
public class FrmMenu extends javax.swing.JFrame {
    ...
    public FrmMenu() {
        ...
        this.jdFecha_actual.setCalendar(fecha_actual);
        this.setLayout(null);
        
        // Crear un JDesktopPane con una imagen de fondo
        jDesktopPane_menu = new JDesktopPane() {
            private Image imagenFondo = new ImageIcon("src/img/FONDONICE.jpeg").getImage(); // Cambia la ruta a la imagen deseada
    ...
    private void initComponents() {
        ...
        javax.swing.JMenuItem jMenuItem_nuevo_usuario = new javax.swing.JMenuItem();
        ...
        jTextField2.setText("SISTEMA DE VENTAS");
        jTextField2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jTextField2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 640, 450, 100));

        jdFecha_actual.setDateFormatString("dd/MM/yyyy HH:mm:ss");
        getContentPane().add(jdFecha_actual, new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 660, 250, 40));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 640, 550, 100));

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/logoNaranja.jpeg"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 650, 140, 80));

        jTextField1.setBackground(new java.awt.Color(255, 153, 0));
        jTextField1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jTextField1.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextField1.setText("                                                                          RESTOBAR \"LA NARANJA MECÁNICA\"");
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 640, 670, 100));
        ...
        jMenuItem_nuevo_usuario.setText("Nuevo Mozo");
        ...
        jMenuItem_gestionar_usuario.setText("Gestionar Mozos");
        ...
        jMenuItem_cerrar_sesion.setPreferredSize(new java.awt.Dimension(190, 30));
